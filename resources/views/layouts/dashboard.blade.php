...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/tailwind-starter-kit/css/Chart.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/tailwind-starter-kit/css/all.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('assets/tailwind-starter-kit/css/compiled-tailwind.min.css') }}" />
    <title>@yield('tab_title', 'tab title not set yet') | {{ config('app.name', 'Laravel') }}</title>
</head>
...
<body class="text-blueGray-700 antialiased">
        ...
        <div class="relative md:ml-64 bg-blueGray-50">
            ...
            <div class="px-4 md:px-10 mx-auto w-full -m-24">
                ...
                <div class="flex flex-wrap mt-4">
                    <div class="w-full xl:w-8/12 mb-12 xl:mb-0 px-4">
                        <div
                            class="relative flex flex-col min-w-0 break-words bg-gray-200 w-full mb-6 shadow-lg rounded">
                            ...
                            <div class="block w-full overflow-x-auto">
                                <!-- Projects table -->
                                <div class="items-center w-full bg-transparent border-collapse px-4 py-3">
    ...
    <script src="{{ asset('assets/tailwind-starter-kit/js/Chart.min.js') }}" charset="utf-8"></script>
    <script src="{{ asset('assets/tailwind-starter-kit/js/popper.min.js') }}" charset="utf-8"></script>
